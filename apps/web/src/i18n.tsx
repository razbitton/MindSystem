...
const englishDictionary = {
  ...
  "projects.deleteProjectHelp": "Remove this project from the project list. Linked tasks, notes, and documents will remain in the workspace.",
...
const hebrewDictionary: Partial<Record<TranslationKey, string>> = {
  ...
  "projects.deleteProjectHelp": "מחיקת הפרויקט תסיר אותו מרשימת הפרויקטים. משימות, הערות ומסמכים מקושרים יישארו במערכת.",
  "projects.deleteConfirm": "האם אתה בטוח שאתה רוצה למחוק את הפרויקט ״{title}״? משימות, הערות ומסמכים שמקושרים אליו יישארו, אבל לא יהיו משויכים לפרויקט הזה.",
