...
const englishDictionary = {
  ...
  "dashboard.noDailyObjectivesBody": "Schedule a task, set a deadline, or pin something for today.",
  ...
  "dashboard.pinObjective": "Pin to today",
  "dashboard.unpinObjective": "Unpin from today",
  "dashboard.dismissToday": "Dismiss today",
  "dashboard.snoozeTomorrow": "Snooze to tomorrow",
  "dashboard.pinToday": "Pin to today",
  "dashboard.pinnedToday": "Pinned to today's objectives",
...
const hebrewDictionary: Partial<Record<TranslationKey, string>> = {
  ...
  "dashboard.noDailyObjectivesBody": "תזמן משימה, קבע תאריך יעד, או הצמד משהו להיום.",
  ...
  "dashboard.pinObjective": "הצמדה להיום",
  "dashboard.unpinObjective": "הסרה מהיום",
  "dashboard.dismissToday": "הסתרה להיום",
  "dashboard.snoozeTomorrow": "דחייה למחר",
  "dashboard.pinToday": "הצמדה להיום",
  "dashboard.pinnedToday": "הוצמד ליעדים של היום",
