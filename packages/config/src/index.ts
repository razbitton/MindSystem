...
const rawEnvSchema = z.object({
  ...
  MCP_SERVER_URL: z.string().url().default("http://localhost:4100/mcp"),
  ...
  OPENAI_CODEX_TOKEN_EXPIRES_AT: z.string().optional().or(z.literal("")),
  OPENAI_CODEX_TOKEN_ENCRYPTION_KEY: z.string().optional().or(z.literal("")),
